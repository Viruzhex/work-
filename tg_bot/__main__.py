        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ᴏᴜʀ ᴄʜᴀɴɴᴇʟ", url="t.me/fx_karthik),  InlineKeyboardButton(text="ᴏᴜʀ ᴄʜᴀɴɴᴇʟ", url="https://t.me/joinchat/yvDEhnSpDY03YWNl")],
                     [InlineKeyboardButton(text=" ᴍʏ ᴄʀᴇᴀᴛᴏʀ ", url="https://t.me/DK121DK"), InlineKeyboardButton(text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ", url="https://t.me/c/1525749124/2")],
                     [InlineKeyboardButton(text="🎬 Youtube Channel", url="https://www.youtube.com/channel/UCHyAUxWRCC98J2FGXlp6x3w"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
